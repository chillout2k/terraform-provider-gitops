...
provider "gitops" {
  ...
  client_secret = ""
  token_uri = "https://iam.internetservices.dev.datev.de/realms/chd/protocol/openid-connect/token"
  auth_uri = "https://iam.internetservices.dev.datev.de/realms/chd/protocol/openid-connect/auth"
  jwks_uri = "https://iam.internetservices.dev.datev.de/realms/chd/protocol/openid-connect/certs"
